...
Stores data in a self-balancing AVL tree a guarentees O(log n)time 
complexity for all lookups and insertions

**key features**
-Streams and parses remote dicitonary datasets 
-Self balancing AVL tree
-Displays actual number of comparisons made during a lookup alongside the theoretical maxmium comparisons 
